...
<div align=center> <img src="https://github.com/CourseCloudDesktop/cloudDesktop/blob/yxf-develop/task5/images/5.jpg" width="60%" height="60%" /></div>
...
三种协议对比：
<div align=center> <img src="https://github.com/CourseCloudDesktop/cloudDesktop/blob/yxf-develop/task5/images/3.png" width="50%" height="50%" /></div>

- 集成脚本修改了什么配置文件导致控制台可以直接用spice而不是用vnc？（请给出相关的配置文件截图）

进入Nova节点，打开nova.conf查看关于VNC和spice的设置，如下所示：
关于spice的设置：

<div align=center> <img src="https://github.com/CourseCloudDesktop/cloudDesktop/blob/yxf-develop/task5/images/1.png" width="60%" height="60%" /></div>

关于vnc的设置：

<div align=center> <img src="https://github.com/CourseCloudDesktop/cloudDesktop/blob/yxf-develop/task5/images/2.png" width="60%" height="60%" /></div>
