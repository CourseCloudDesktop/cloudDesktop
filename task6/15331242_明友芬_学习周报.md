...
<div align=center> <img src="https://github.com/CourseCloudDesktop/cloudDesktop/tree/yxf-develop/task6/image/5.jpg" width="60%" height="60%" /></div>

### Nova架构：

<div align=center> <img src="https://github.com/CourseCloudDesktop/cloudDesktop/tree/yxf-develop/task6/image/6.jpg" width="60%" height="60%" /></div>
...
<div align=center> <img src="https://github.com/CourseCloudDesktop/cloudDesktop/tree/yxf-develop/task6/image/7.jpg" width="60%" height="60%" /></div>
...
<div align=center> <img src="https://github.com/CourseCloudDesktop/cloudDesktop/tree/yxf-develop/task6/image/8.jpg" width="60%" height="60%" /></div>
...
<div align=center> <img src="https://github.com/CourseCloudDesktop/cloudDesktop/tree/yxf-develop/task6/image/9.jpg" width="60%" height="60%" /></div>
...
<div align=center> <img src="https://github.com/CourseCloudDesktop/cloudDesktop/tree/yxf-develop/task6/image/10.jpg" width="60%" height="60%" /></div>
...
<div align=center> <img src="https://github.com/CourseCloudDesktop/cloudDesktop/tree/yxf-develop/task6/image/11.jpg" width="60%" height="60%" /></div>
...
<div align=center> <img src="https://github.com/CourseCloudDesktop/cloudDesktop/tree/yxf-develop/task6/image/12.jpg" width="60%" height="60%" /></div>

创建实例的时候，会让我们选择可用域：

<div align=center> <img src="https://github.com/CourseCloudDesktop/cloudDesktop/tree/yxf-develop/task6/image/13.jpg" width="60%" height="60%" /></div>
...
<div align=center> <img src="https://github.com/CourseCloudDesktop/cloudDesktop/tree/yxf-develop/task6/image/14.jpg" width="60%" height="60%" /></div>
...
<div align=center> <img src="https://github.com/CourseCloudDesktop/cloudDesktop/tree/yxf-develop/task6/image/15.jpg" width="60%" height="60%" /></div>
...
<div align=center> <img src="https://github.com/CourseCloudDesktop/cloudDesktop/tree/yxf-develop/task6/image/17.jpg" width="60%" height="60%" /></div>
...
<div align=center> <img src="https://github.com/CourseCloudDesktop/cloudDesktop/tree/yxf-develop/task6/image/18.jpg" width="60%" height="60%" /></div>
...
<div align=center> <img src="https://github.com/CourseCloudDesktop/cloudDesktop/tree/yxf-develop/task6/image/19.jpg" width="60%" height="60%" /></div>

<div align=center> <img src="https://github.com/CourseCloudDesktop/cloudDesktop/tree/yxf-develop/task6/image/20.jpg" width="60%" height="60%" /></div>

<div align=center> <img src="https://github.com/CourseCloudDesktop/cloudDesktop/tree/yxf-develop/task6/image/21.jpg" width="60%" height="60%" /></div>

<div align=center> <img src="https://github.com/CourseCloudDesktop/cloudDesktop/tree/yxf-develop/task6/image/22.jpg" width="60%" height="60%" /></div>

<div align=center> <img src="https://github.com/CourseCloudDesktop/cloudDesktop/tree/yxf-develop/task6/image/23.jpg" width="60%" height="60%" /></div>

nova-conductor 在调用 nova-scheduler 来获取能够创建 Instance 的 Host 的同时也获取了：requested_networks/flavor 等信息。
其中获取 Hosts 列表的代码块：

<div align=center> <img src="https://github.com/CourseCloudDesktop/cloudDesktop/tree/yxf-develop/task6/image/24.jpg" width="60%" height="60%" /></div>

这个函数调用如下所示：

<div align=center> <img src="https://github.com/CourseCloudDesktop/cloudDesktop/tree/yxf-develop/task6/image/25.jpg" width="60%" height="60%" /></div>

这个函数首先调用了nova-scheduler里面的utils里的setup_instance_group函数

<div align=center> <img src="https://github.com/CourseCloudDesktop/cloudDesktop/tree/yxf-develop/task6/image/26.jpg" width="60%" height="60%" /></div>


然后调用客户端client里面的query里的select_destinations函数；这个函数有调用了rpcapi函数。

<div align=center> <img src="https://github.com/CourseCloudDesktop/cloudDesktop/tree/yxf-develop/task6/image/27.jpg" width="60%" height="60%" /></div>

<div align=center> <img src="https://github.com/CourseCloudDesktop/cloudDesktop/tree/yxf-develop/task6/image/28.jpg" width="60%" height="60%" /></div>


### 3.2 阶段二：从 scheduler.rpcapi.SchedulerAPI 到 scheduler.manager.SchedulerManager

<div align=center> <img src="https://github.com/CourseCloudDesktop/cloudDesktop/tree/yxf-develop/task6/image/29.jpg" width="60%" height="60%" /></div>
...
<div align=center> <img src="https://github.com/CourseCloudDesktop/cloudDesktop/tree/yxf-develop/task6/image/30.jpg" width="60%" height="60%" /></div>

还有实现获取满足第一次过滤条件的主机列表的_schedule函数：

<div align=center> <img src="https://github.com/CourseCloudDesktop/cloudDesktop/tree/yxf-develop/task6/image/31.jpg" width="60%" height="60%" /></div>

### 3.4 阶段四：从调度器FilterScheduler到过滤器Filters（如何实现所有的过滤工作的）
也即函数get_filtered_host()函数的具体实现

<div align=center> <img src="https://github.com/CourseCloudDesktop/cloudDesktop/tree/yxf-develop/task6/image/32.jpg" width="60%" height="60%" /></div>

继续跳转到get_filtered_objects处：

<div align=center> <img src="https://github.com/CourseCloudDesktop/cloudDesktop/tree/yxf-develop/task6/image/33.jpg" width="60%" height="60%" /></div>

继续追踪查看filters的HostFilterHander()函数，这个函数实现了过滤器的基类：

<div align=center> <img src="https://github.com/CourseCloudDesktop/cloudDesktop/tree/yxf-develop/task6/image/34.jpg" width="60%" height="60%" /></div>

在host_manager.py里面对过滤器的调度：

<div align=center> <img src="https://github.com/CourseCloudDesktop/cloudDesktop/tree/yxf-develop/task6/image/35.jpg" width="60%" height="60%" /></div>
...
<div align=center> <img src="https://github.com/CourseCloudDesktop/cloudDesktop/tree/yxf-develop/task6/image/37.jpg" width="60%" height="60%" /></div>

追踪weight_handler:

<div align=center> <img src="https://github.com/CourseCloudDesktop/cloudDesktop/tree/yxf-develop/task6/image/38.jpg" width="60%" height="60%" /></div>

<div align=center> <img src="https://github.com/CourseCloudDesktop/cloudDesktop/tree/yxf-develop/task6/image/39.jpg" width="60%" height="60%" /></div>

<div align=center> <img src="https://github.com/CourseCloudDesktop/cloudDesktop/tree/yxf-develop/task6/image/40.jpg" width="60%" height="60%" /></div>
